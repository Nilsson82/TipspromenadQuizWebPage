...
const CACHE='tipspromenad-portable-v1-20260920-parity-v2';
const FILES=['./','index.html','script.js','styles.css','walk.css','lib/quiz-core.js','lib/i18n.js','lib/quiz-ui.js','lib/correction.js','lib/vendor/qrcode.js','lib/vendor/jsQR.js','lib/walk-core.js','lib/walk-store.js','lib/walk-motion.js','lib/walk-ui.js','lib/walk-progress.js','lib/walk-lan.js','lib/walk-database.js','locales/ui.json','locales/walk.json','Data/revision-1.json','Data/revision-2.json','Data/multilingual.json','Data/data_en.json','Data/data_sv.json','Data/data_es.json'];
